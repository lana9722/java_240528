...
public class ComparisonOperatorEx01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("str1 == str2 : " + (str1 == str3));//str3은 리터럴이 아닌 방법으로 저장하기 때문에 주소가 다름
		System.out.println("str1 == str2 : " + (str2 == str3));//str3은 리터럴이 아닌 방법으로 저장하기 때문에 주소가 다름
		//문자열은 equals를 이용하여 비교해야 함.
		System.out.println("str1 == str2 : " + (str1.equals(str2)));
		System.out.println("str1 == str2 : " + (str1.equals(str3)));
		System.out.println("str1 == str2 : " + (str2.equals(str3)));

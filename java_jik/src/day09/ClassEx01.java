...
public class ClassEx01 {
	...
	public static void main(String[] args) {
		//학생 객체를 생성할 떄 생성자를 이용하여 초기화
		Student1 std1 = new Student1();
		Student1 std2 = new Student1(1,1,1, "홍길동");
		std2.print();
		/*멤버변수와 메서드는 객체명.멤버변수 또는 객체명.메소드명(매개변수들)을 이용하여 호출 할 수 있다
		 * 단, 접근 제어자에 따라 제한될 수 있다*/
		std1.name = "임꺽정";
		std1.print();
 ...
 * 클래스 이름은 Student1이고, 이때 필요한 멤버 변수를선언해보세요. 
 */
  //클래스 이름
	class Student1{
